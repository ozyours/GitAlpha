...
/**
 * Callback fired when the active tab changes in an {@link ASubTabPane}.
 * Listeners are held as weak references by the pane and pruned on broadcast,
 * matching the event-list pattern used by
